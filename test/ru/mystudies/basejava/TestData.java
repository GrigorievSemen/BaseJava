    ...
    static {
        ...
        RESUME_1.addSection(SectionType.EXPERIENCE,
                new OrganizationSection(
                        new Organization("Name organization_1", "Web_1", "Заголовок описания_1",
                                new Period(DateUtil.of(2001, Month.SEPTEMBER), DateUtil.of(2002, Month.DECEMBER), "Опыт_1")),
                        new Organization("Name organization_2", "Web_2", "Заголовок описания_2",
                                new Period(DateUtil.of(2002, Month.JANUARY), DateUtil.of(2003, Month.MAY), "Опыт_2"),
                                new Period(DateUtil.of(2003, Month.FEBRUARY), DateUtil.of(2004, Month.MARCH), "Опыт_3"))));
